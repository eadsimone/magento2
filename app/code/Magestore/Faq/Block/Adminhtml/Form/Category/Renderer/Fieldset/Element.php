 ...
 */
namespace Magestore\Faq\Block\Adminhtml\Form\Category\Renderer\Fieldset;
...
class Element extends \Magento\Backend\Block\Widget\Form\Renderer\Fieldset\Element {
	...
	public function canDisplayUseDefault() {
		return ($this->getRequest()->getParam('store') &&
			$this->getElement()->getDateFormat() == null) ? true : false;
	}
	...
	public function checkFieldDisable() {
		if (!$this->getElementStoreViewId() && $this->getElementName() != 'category_id'
	...
	public function getScopeLabel() {
		if ($this->getElement()->getDateFormat() != null) {
			return '[GLOBAL]';
		}
		return '[STORE VIEW]';
	}
