...
class Category extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function __construct(
        ...
        \Magestore\Faq\Model\ResourceModel\Category $resource,
        \Magento\Store\Model\StoreManagerInterface $storeManager,
        \Magestore\Faq\Model\CategoryFactory $categoryFactory,
        \Magestore\Faq\Model\CategoryvalueFactory $valueFactory,
        \Magestore\Faq\Model\ResourceModel\Categoryvalue\CollectionFactory $categoryValueCollectionFactory,
        \Magestore\Faq\Model\ResourceModel\Category\Collection $resourceCollection
    )
    {
        parent::__construct(
            $context,
